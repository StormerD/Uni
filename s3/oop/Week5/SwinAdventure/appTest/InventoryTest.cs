namespace SwinAdventure {
    public class InventoryTest {
        ...
        [SetUp] // Setup
        public void SetUp() {
            _item1 = new Item(new string[] {"axe", "stone"}, "stone axe", "a stone axe used to chop trees");
            _item2 = new Item(new string[] {"sword", "iron", "weapon"}, "iron sword", "an iron sword used to slay monsters");
