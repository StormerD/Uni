    ...
    public static void Main() {
      ...
      do {
        ...
        if (SplashKit.KeyTyped(KeyCode.NKey)) {
          ...
          MyCircle top = new MyCircle();
          top.X = baseX + 40;
          top.Y = baseY + 40;
          top.Radius = 40;
          top.Color = baseColor;
          _myDrawing.AddShape(top);
          
          // Bottom curve (as a circle)
          MyCircle bottom = new MyCircle();
          bottom.X = baseX + 40;
          bottom.Y = baseY + 79;
          bottom.Radius = 40;
          bottom.Color = baseColor;
          _myDrawing.AddShape(bottom);
          
          // Middle curve (as a circle)
          MyCircle middle = new MyCircle();
          middle.X = baseX + 45;
          middle.Y = baseY + 59;
          middle.Radius = 45;
          middle.Color = baseColor;
          _myDrawing.AddShape(middle);
          
          Console.WriteLine("New Shape Added: D");
        }
